...
public class CrmContactCreating {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("crm_contact[lastName]")).sendKeys("Кенонен");

        driver.findElement(By.name("crm_contact[firstName]")).sendKeys("Тахво");

        driver.findElement(By.xpath("//span[@class = 'select2-arrow']")).click();
        driver.findElement(By.xpath("//input[@class='select2-input select2-focused']")).sendKeys("Все организации");
