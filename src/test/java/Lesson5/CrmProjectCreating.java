...
public class CrmProjectCreating {
    ...
    void crmProjectCreating() {
        ...
        driver.findElement(By.name("crm_project[name]")).sendKeys("test162");
...
//        private void loginViaCookie() throws InterruptedException {
//        driver.get(LOGIN_PAGE_URL);
//        Cookie sessionCookie = driver.manage().getCookieNamed("BAPID");
//        driver.manage().deleteCookie(sessionCookie);
//        Cookie cookie = new Cookie("BAPID", "ffdc7668e1c627f00cc2b3e30b690f9e");
